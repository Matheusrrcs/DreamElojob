...
>>>>>>> 768d054bd57b90fcc756aa6c8035353acf220d86
...
function coach() {
    ...
    if (lga == 1) {
        text = 'Olá, estou no site e quero ' + titles + ' de ' + ch + " de " + lga + " partida " + value

    }
    else {
        text = 'Olá, estou no site e quero ' + titles + ' de ' + ch + " de " + lga + " partidas " + value
